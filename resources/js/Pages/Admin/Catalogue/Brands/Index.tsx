                            ...
                            <tr>
                                <td colSpan={4} className="py-16 text-center">
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <p className="text-sm font-medium text-slate-500">No brands yet</p>
                                        <p className="text-xs text-slate-500">Add your first LPG brand to get started.</p>
                                    </div>
                                </td>
                            </tr>
                        )}
                                ...
                                <td className="px-5 py-4">
                                    <div className="flex flex-wrap gap-1">
                                        {b.sizes.length === 0
                                            ...
                                            : b.sizes.map(s => (
                                                <span key={s.id} className="inline-flex items-center rounded-full border border-orange-200 bg-orange-50 px-2 py-0.5 text-2xs font-semibold text-orange-700">
                                                    {s.name}
                                                </span>
                                            ))
                                        }
