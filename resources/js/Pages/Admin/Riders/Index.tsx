            ...
            <div className="relative rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                            ...
                            <tr>
                                <td colSpan={6} className="py-16 text-center">
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <p className="text-sm font-medium text-slate-500">No riders found</p>
                                        <p className="text-xs text-slate-500">Add your first rider or adjust the filters.</p>
                                    </div>
                                </td>
                            </tr>
                        )}
                            ...
                            <tr key={r.id} className={cn('transition-colors group', !r.is_active ? 'opacity-60' : 'hover:bg-slate-50/50')}>
                                <td className="px-5 py-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        {!r.is_active && (
                                            <span className="rounded-full border border-slate-200 bg-slate-100 px-2 py-0.5 text-2xs font-semibold text-slate-500">Inactive</span>
                                        )}
                                    </div>
                                </td>
                                <td className="px-5 py-4">
                                ...
                                <td className="px-5 py-4">
                                    ...
                                    {!r.is_safety_certified && <span className="text-xs text-slate-500 italic">None</span>}
                                </td>
                                        ...
                                        <DropdownMenuContent align="end" className="w-40">
                                            <DropdownMenuItem asChild>
                                                <Link href={`/admin/riders/${r.id}`} className="flex items-center gap-2 cursor-pointer">
                                                    <Eye className="h-3.5 w-3.5 text-slate-500" /> View Profile
                                                </Link>
                                            </DropdownMenuItem>
                                            <DropdownMenuItem asChild>
                ...
                {riders.last_page > 1 && (
                    <div className="flex items-center justify-between border-t border-slate-100 px-5 py-3">
                        <p className="text-xs text-slate-500">Page {riders.current_page} of {riders.last_page}</p>
