...
export default function AdminUsersCreate({ roles }: Props) {
    ...
    const {
        ...
        defaultValues: { name: '', email: '', password: '', password_confirmation: '', role: '', is_active: true },
    });
    ...
    return (
        <AdminLayout title="Add Admin User" subtitle="Create a new portal admin account">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <div className="flex items-center gap-3 rounded-lg border border-slate-100 bg-slate-50 px-4 py-3">
                            ...
                            <Label htmlFor="is_active" className="text-sm font-normal text-slate-600 cursor-pointer">
                                Account is active (can log in immediately)
                            </Label>
                        </div>
