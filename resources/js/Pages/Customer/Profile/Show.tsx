                    ...
                    <div className="divide-y divide-slate-100">
                        <div className="flex items-center gap-3 px-4 py-3">
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="text-2xs text-slate-500 font-medium uppercase">Phone</p>
                        ...
                        <div className="flex items-center gap-3 px-4 py-3">
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="text-2xs text-slate-500 font-medium uppercase">Referral Code</p>
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {addr.is_default && (
                                                <span className="rounded-full border border-orange-200 bg-orange-100 px-2 py-0.5 text-2xs font-semibold text-orange-700">
                                                    Default
                                                </span>
                                            )}
                                        </div>
                                    ...
                                    <div className="flex items-center gap-1 shrink-0">
                                        {!addr.is_default && (
                                            <button
                                                ...
                                                className="rounded-lg border border-slate-200 px-2 py-1 text-2xs font-medium text-slate-600 hover:bg-slate-100 transition-colors"
                                            >
                                                Set default
                                            </button>
                                        )}
                                        ...
                                        <button
                                            ...
                                            className="rounded-lg p-1.5 text-slate-500 hover:bg-red-50 hover:text-red-500 transition-colors"
                                        >
                            ...
                            {recentOrders.map(o => (
                                ...
                                >
                                    ...
                                    <div className="text-right shrink-0">
                                        ...
                                        <span className={cn('rounded-full px-2 py-0.5 text-2xs font-medium', STATUS_COLORS[o.status] ?? 'bg-slate-100 text-slate-500')}>
