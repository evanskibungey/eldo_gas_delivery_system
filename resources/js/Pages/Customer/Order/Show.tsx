...
export default function Show({ order, mpesa_till }: Props) {
    ...
    return (
        <CustomerLayout title={`Order ${order.order_number}`} showBack backHref="/orders">
            <div className="mx-auto max-w-sm md:max-w-4xl px-4 py-4 space-y-4">

                {/* Header status — full width on both viewports */}
                ...
                <div className="md:grid md:grid-cols-2 md:gap-6 space-y-4 md:space-y-0">
                    ...
                    {/* LEFT: Order details + Price breakdown + Delivery notes */}
                    ...
                    {/* RIGHT: Rider + Status history + Actions */}
                    <div className="space-y-4">
